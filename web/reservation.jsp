        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>List <b>All Reservation</b></h2>
                        </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach var="room" items="${listReservationdt}">
                            ...
                            <tr>
                                ...
                                <td>${room.specialRequest}</td>


                                <td>
                                    <a href="setroom?roomNo=${room.roomNo}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
